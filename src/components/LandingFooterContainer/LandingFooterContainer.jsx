        ...
        <footer-landing style={{background: "#2D2F3A"}}>
            ...
            <div>
                <ul className="footer__landing__nav__links">
                    ...
                    <li><a href="https://twitter.com/GreenwoodDeFi" title="Greenwood Twitter"><span><Twitter className="va-middle-bg-transparent filled-footer-landing-icon" /></span></a></li>
